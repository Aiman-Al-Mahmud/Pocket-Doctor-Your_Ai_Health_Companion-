class ReviewRequestModel {
  ...
  String get patientInitials => 'PT';
  String get patientName => 'Patient #${patientId.substring(0, 4)}';
  String get complaintTag => medicalDivision;
  String get complaintDesc => userQuery.length > 35 ? '${userQuery.substring(0, 35)}...' : userQuery;
  double get accuracy => 0.92;
